...
async def get_shared_chat_by_id(share_id: str, user=Depends(get_verified_user)):
    ...
    if user.role == "user" or user.role == "student" or (user.role == "admin" and not ENABLE_ADMIN_CHAT_ACCESS):
        chat = Chats.get_chat_by_share_id(share_id)
    elif user.role == "admin" and ENABLE_ADMIN_CHAT_ACCESS or user.role == "teacher":
